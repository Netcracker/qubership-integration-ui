...
export const LoggingSettings: React.FC = () => {
  ...
  const getLoggingSettings = async (): Promise<ChainLoggingSettings | null> => {
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to get logging settings", error);
      return null;
    } finally {
  ...
  const getMaskedFields = async (): Promise<MaskedField[]> => {
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to get masked fields", error);
      return [];
    } finally {
  ...
  const updateMaskedField = async (
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to update masked field", error);
    } finally {
      setIsMaskedFieldsLoading(false);
    }
  };
  ...
  const createMaskedField = async () => {
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to create masked field", error);
    } finally {
      setIsMaskedFieldsLoading(false);
    }
  };
  ...
  const deleteSelectedMaskedFields = async () => {
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to delete masked fields", error);
    } finally {
      setIsMaskedFieldsLoading(false);
    }
  };
  ...
  const deleteLoggingSettings = async () => {
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to delete logging settings", error);
      return null;
    } finally {
      setIsLoggingSettingsLoading(false);
    }
  ...
  const updateLoggingProperties = async (
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to update logging settings", error);
    } finally {
      setIsLoggingSettingsLoading(false);
    }
  };
