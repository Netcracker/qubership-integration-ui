...
export const Sessions: React.FC = () => {
  ...
  const fetchSessions = async (reset?: boolean) => {
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to fetch sessions", error);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const retryFromLastCheckpoint = async (
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to retry session", error);
    }
  };
  ...
  const deleteSelectedSessions = async () => {
    try {
      ...
      notificationService.errorWithDetails("Failed to delete sessions", error);
    }
  };
  ...
  const onExportBtnClick = async () => {
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to export sessions", error);
    }
  };
    ...
    const promises = selectedRowKeys
      ...
      .map(async (session) => {
        try {
          ...
          notificationService.errorWithDetails(`Failed to retry session ${session.id}`, error);
        }
      });
