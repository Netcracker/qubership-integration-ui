...
export const Snapshots: React.FC = () => {
  ...
  const deleteSnapshot = async (snapshot: Snapshot) => {
    try {
      ...
      notificationService.errorWithDetails("Failed to delete snapshot", error);
    }
  };
  ...
  const deleteSelectedSnapshots = async () => {
    try {
      ...
      notificationService.errorWithDetails("Failed to delete snapshots", error);
    }
  };
  ...
  const updateSnapshot = async (
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to update snapshot", error);
    }
  };
  ...
  const revertToSnapshot = async (id: string) => {
    ...
    try {
      ...
      notificationService.errorWithDetails("Failed to revert to snapshot", error);
    }
  };
