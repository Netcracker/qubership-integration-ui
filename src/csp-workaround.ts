 ...
 */
function restoreInlineStyles(container: Element, styleMap: Map<number, string>) {
...
Element.prototype.insertAdjacentHTML = function (position, html) {
  ...
  const isOutsidePosition = position === 'beforebegin' || position === 'afterend';
  const searchContainer = isOutsidePosition ? this.parentElement ?? this : this;
