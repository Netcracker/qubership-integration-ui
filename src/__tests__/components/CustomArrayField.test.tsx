...
import type {
  ...
  ResponseValidation,
  RequestValidation,
} from "../../components/modal/chain_element/field/CustomArrayField";
...
jest.mock(
  "../../components/modal/chain_element/field/CustomArrayField.module.css",
  () => ({
    __esModule: true,
    default: {
      container: "container",
...
import CustomArrayField from "../../components/modal/chain_element/field/CustomArrayField";
