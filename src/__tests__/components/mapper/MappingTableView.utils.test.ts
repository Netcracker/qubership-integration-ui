...
jest.mock("../../../components/mapper/LoadConfirmationDialog.tsx", () => ({
...
import type { MappingTableItem } from "../../../components/mapper/MappingTableView";
import type {
  MappingDescription,
  DataType,
  ValueSupplier,
