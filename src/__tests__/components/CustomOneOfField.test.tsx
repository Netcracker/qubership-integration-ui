...
import type { FormContext } from "../../components/modal/chain_element/ChainElementModificationContext";
...
import CustomOneOfField from "../../components/modal/chain_element/field/CustomOneOfField";
...
const httpTriggerSchema: RJSFSchema = {
  ...
  oneOf: [
    ...
    },
    {
      ...
      required: ["integrationSystemId", "integrationOperationPath", "httpMethodRestrict"],
    },
  ],
};
...
describe("HttpTriggerOneOfField", () => {
  ...
  it("defaults to Custom (index 0) when no integrationSystemId", () => {
    ...
    expect(schemaFieldCall.schema.properties).toHaveProperty("httpMethodRestrict");
  ...
  it("defaults to Implemented Service (index 1) when integrationSystemId present", () => {
    ...
    expect(schemaFieldCall.schema.properties).not.toHaveProperty("httpMethodRestrict");
    expect(schemaFieldCall.schema.properties).toHaveProperty("integrationSystemId");
  });
