...
import { ServiceNameBreadcrumbItem, ServiceTypeBreadcrumbItem } from "./ServiceBreadcrumb";
  ...
  return (
    <ServiceParametersPageLayout>
        <Breadcrumb>
            ...
            <ServiceNameBreadcrumbItem type={IntegrationSystemType.CONTEXT} id={systemId} name={systemId}/>
        </Breadcrumb>
